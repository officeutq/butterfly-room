...
画像欄の上には、公開と店舗画像について次の説明を表示します。

> 店舗情報を「公開」にすると、Googleなどの検索結果に表示される可能性があり、お店を知ってもらうきっかけになります。
>
> お店の雰囲気が伝わる店舗画像（サムネイル）の設定がおすすめです。店舗一覧や店舗詳細、リンクを共有した際の紹介画像に使われます。
...
新規作成・編集画面では、画像欄の上に次の説明を表示します。

> ブースは、店舗に所属するオンラインの配信ルームです。同じブースを繰り返し配信に使い、配信履歴や売上を確認できます。
>
> ここでは、視聴者に表示するブースの画像・名前・説明文を設定します。
