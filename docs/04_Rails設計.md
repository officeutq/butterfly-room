...
2026-09-17 / #1336：配信接続の開始確認・切断は初回＋追加最大3回（0.5秒・1秒・2秒）とし、最終失敗をエラー表示・既存エラーログへ残す。専用の再確認ボタンを廃止し、DB終了・返却が完了した通常／強制終了は切断結果にかかわらずリザルトへ進む。未確認接続の開始制限・画面の有限な結果取得・運用復旧は[実配信者設計3・5節](design/actual_publisher.md)を参照。ステージング・本番へ未反映。
