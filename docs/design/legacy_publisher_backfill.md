...
固定一覧のSHA-256は`2e680cad391341eaddd6371fbd25f6ef492975abc109782f412e4dc3c2175716`、基準時刻は2026-09-15 01:09:35.886426 UTC。適用件数12、競合・失敗なし。保管場所・バックアップ・有効化結果は[移行手順](../ops/actual_publisher_rollout.md)を参照。本番は実行権限の追加待ちで未適用。
