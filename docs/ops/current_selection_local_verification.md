...
- #1278：操作手順・設計書・選択画面の撮影をローカル更新済み。[選択画面の撮影記録](../user_manual/selection_capture.md)で更新画像と未撮影範囲を管理する。
...
| #1274・#1275・#1276 | サーバー入口#1322、ヘッダー・カード#1323、準備切替#1324。作業ブランチを順に重ねている |
...
各番号は[GitHub Issue一覧](https://github.com/officeutq/butterfly-room/issues)、PRは[Pull Request一覧](https://github.com/officeutq/butterfly-room/pulls)から参照できる。まだマージ・環境展開を完了した記録ではない。
