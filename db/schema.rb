...
ActiveRecord::Schema[8.1].define(version: 2026_09_22_000000) do
  ...
  create_table "booths", force: :cascade do |t|
    ...
    t.index ["last_online_at"], name: "index_booths_on_last_online_at"
  ...
  create_table "store_cast_invitations", force: :cascade do |t|
    ...
    t.index ["invited_by_user_id", "request_key"], name: "idx_on_invited_by_user_id_request_key_23eded17e1", unique: true
  ...
  create_table "store_contact_submissions", force: :cascade do |t|
    t.text "body"
    t.string "business_type", limit: 120
  ...
  create_table "stream_publisher_connections", force: :cascade do |t|
    ...
    t.datetime "disconnect_in_flight_at"
